...
export const Projects: React.FC = () => {
  ...
  return (
    <div
      id={PROJECTS_PAGE}
      className={cn(
        'element-page relative h-auto md:h-screen w-screen p-[100px_10vw_0_10vw] md:pt-0 lg:pt-[100px] bg-projects dark:bg-projects-dark flex flex-col md:justify-center lg:justify-start',
        {
          [`md:h-auto`]: !!overflow
        }
      )}
